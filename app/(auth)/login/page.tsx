    ...
    <div className="bg-gray-900/90 border border-gray-800 rounded-xl p-6 sm:p-8 shadow-xl">
      ...
      <div className="mb-6 sm:mb-8">
        ...
        <p className="text-xs sm:text-sm text-gray-400 mt-1 sm:mt-2">
          Sign in to your SentinelAuth account
        </p>
      </div>
      ...
      <form className="space-y-4 sm:space-y-5">
        ...
        <div className="flex items-center justify-between">
          <label className="flex items-center gap-2">
            <input type="checkbox" className="w-3.5 h-3.5 sm:w-4 sm:h-4 bg-black border-gray-700 rounded focus:ring-red-500" />
      ...
      {/* Social Login - Stack on mobile, side by side on desktop */}
      ...
      <p className="text-center text-xs sm:text-sm text-gray-500 mt-6 sm:mt-8">
        ...
        <Link href="/register" className="text-red-500 hover:text-red-400 transition font-medium">
          Sign up free
        </Link>
      </p>
    </div>
